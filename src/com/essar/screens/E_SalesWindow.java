 ...
 * @author rahumathulla
 */
public class E_SalesWindow extends javax.swing.JFrame implements ActionListener{
    ...
    private void initComponents() {
        ...
        lblCustomerType.setForeground(new java.awt.Color(0, 102, 204));
        ...
        lblCustomerName.setForeground(new java.awt.Color(0, 102, 204));
    ...
    private void btnViewAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewAllActionPerformed
        ...
        E_ViewSales salesView =  new E_ViewSales();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        E_SalesFind salesFind = new E_SalesFind();
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        String reportString="";
        System.out.println("!@#--------"+txtBillNumber.getText());
        if(txtBillNumber.getText().contains("E-")){
            reportString="src\\com\\essar\\reports\\estimate.jrxml";
        }else{
            reportString="src\\com\\essar\\reports\\estimate.jrxml";
        }
        ...
        try {
            ...
            Logger.getLogger(E_SalesWindow.class.getName()).log(Level.SEVERE, null, ex);
        }
        JasperPrint jp = null;
        try {
    ...
    private void cmbCustomerNameActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbCustomerNameActionPerformed
        // TODO add your handling code here:
        try{
            if("new".equalsIgnoreCase(((Staff) cmbCustomerName.getSelectedItem()).getStaffName())
        ...
        try{
            ...
            if(!(btnSave.getText().equalsIgnoreCase("update"))){
                ...
                if(billType.equalsIgnoreCase("B2B")){
                    txtBillNumber.setText("EB-"+billSeqNumber);
                    //txtDisplayName.requestFocus();
                }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(E_SalesWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new E_SalesWindow().setVisible(true);
            }
        });
    }
    ...
    public void saveSalesForm(){
        ...
        Staff customer = (Staff)cmbCustomerName.getSelectedItem();
