...
public class DayBookForm extends javax.swing.JFrame implements ActionListener{
    ...
    private void initComponents() {
        ...
        lblBillVoucher = new javax.swing.JLabel();
        txtBillVoucherNumber = new javax.swing.JTextField();
        ...
        tblDayBook.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Particular Name", "Debit", "Credit", "Remarks", "Bill/Voucher No:", "id"
            }
        ) {
        ...
        lblBillVoucher.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        lblBillVoucher.setText("Bill/Voucher Number");

        txtBillVoucherNumber.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        txtBillVoucherNumber.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtBillVoucherNumberActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txtBillVoucherNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 106, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGap(8, 8, 8)
                                .addComponent(txtBillVoucherNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void txtBillVoucherNumberActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtBillVoucherNumberActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtBillVoucherNumberActionPerformed
    /**
    ...
    public void initializeForm(){
        ...
        TableColumn remarksColumn = tblDayBook.getColumnModel().getColumn(tblDayBook.getColumnCount()-3);
        remarksColumn.setPreferredWidth(460);
        remarksColumn.setMinWidth(460);
    ...
    public void enableFormElements(boolean flag){
        ...
        txtBillVoucherNumber.setEnabled(flag);
    ...
    public boolean validateForm(){
        ...
        if(null == txtBillVoucherNumber.getText() || "".equalsIgnoreCase(txtBillVoucherNumber.getText().trim())){
            JOptionPane.showMessageDialog(null, "Bill/Voucher Number "+txtBillVoucherNumber.getText() +" is not valid.");
            txtBillVoucherNumber.requestFocus();
            return false;
        }
    ...
    public void saveDayBookForm(){
        ...
        dayBook.setReferenceNumber(txtBillVoucherNumber.getText());
    ...
    public void renderDataIntoTable(List<DayBook> dayBookList){
        ...
        for(int i=0;i<dayBookList.size();i++){
            dayBookModel.addRow(new Object[]{sdf.format(dayBookList.get(i).getEventDate()),dayBookList.get(i).getParticularName(),dayBookList.get(i).getDebitAmount(),dayBookList.get(i).getCreditAmount(), dayBookList.get(i).getRemarks(), dayBookList.get(i).getReferenceNumber(),dayBookList.get(i).getDayBookId()});
    ...
    private javax.swing.JLabel lblBillVoucher;
    ...
    private javax.swing.JTextField txtBillVoucherNumber;
    ...
    public void actionPerformed(ActionEvent event) {
        try{
            ...
            if (menu == mitEdit) {
                ...
                txtBillVoucherNumber.setText(dayBook.getReferenceNumber());
                //btnSave.setText("Save");
                //btnSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/save.png")));
