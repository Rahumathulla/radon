 ...
 * @author rahumathulla
 */
public class Vp_SalesWindow extends javax.swing.JFrame implements ActionListener{
    ...
    private void btnViewAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewAllActionPerformed
        ...
        Vp_ViewSales salesView =  new Vp_ViewSales();
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        Vp_SalesFind salesFind = new Vp_SalesFind();
    ...
    private void btnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintActionPerformed
        ...
        if(txtBillNumber.getText().contains("B-")){
            reportString="src\\com\\essar\\reports\\first_choice_b2b_vp.jrxml";
        }else{
            reportString="src\\com\\essar\\reports\\first_choice_vp.jrxml";
        }
        ...
        try{
            ...
            if(!(btnSave.getText().equalsIgnoreCase("update"))){
                ...
                if(billType.equalsIgnoreCase("B2B")){
                    txtBillNumber.setText("VB-"+billSeqNumber);
                    //txtDisplayName.requestFocus();
                }else{
                    txtBillNumber.setText("V-"+billSeqNumber);
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Vp_SalesWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Vp_SalesWindow().setVisible(true);
            }
        });
    }
