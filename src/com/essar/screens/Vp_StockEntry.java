...
public class Vp_StockEntry extends javax.swing.JFrame implements ActionListener{
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        if(btnSave.getText().equalsIgnoreCase("add")){
            ClassMasterDAO categoryDAO = new ClassMasterDAO();
    ...
    public final void fetchStockDataIntoTable(Stock stock){
        ...
        for(int i=0; i<cmbCategory.getItemCount();i++){
            if(((ClassMaster)cmbCategory.getItemAt(i)).getClassName().equalsIgnoreCase(stock.getCategory())){
    ...
    public void renderCategoryDataIntoDropDown(List<ClassMaster> categoryList){
        ClassMaster productCategory = null;
        cmbCategory.removeAllItems();
        if(categoryList!= null){
            ...
            cmbCategory.setSelectedIndex(0);
            productCategory = (ClassMaster)cmbCategory.getSelectedItem();            
        }  
    }
